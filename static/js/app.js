function initCheckAll() {
    ...
    $(".table-check .form-check-input").change(function () {
        $(".table-check .form-check-input:checked").length == $(".table-check .form-check-input").length
...
!function (c) {
                ...
                : "sp" == e
                    ...
                    : "gr" == e
                        ...
                        : "it" == e
                            ...
                            : "ru" == e && (document.getElementById("header-lang-img").src = "../../static/images/flags/russia.jpg"),
    ...
    function s() {
        for (var e = document.getElementById("topnav-menu-content").getElementsByTagName("a"), t = 0, c = e.length; t < c; t++)
            "nav-item dropdown active" === e[t].parentElement.getAttribute("class") && (e[t]
                .parentElement
                .classList
                .remove("active"), null !== e[t].nextElementSibling && e[t]
                .nextElementSibling
                .classList
                .remove("show"))
    ...
    function l(e) {
        1 == c("#light-mode-switch").prop("checked") && "light-mode-switch" === e
            ? (c("html").removeAttr("dir"), c("#dark-mode-switch").prop("checked", !1), c("#rtl-mode-switch").prop("checked", !1), c("#dark-rtl-mode-switch").prop("checked", !1), c("#bootstrap-style").attr("href", "../../static/css/bootstrap.min.css"), c("#app-style").attr("href", "../../static/css/app.min.css"), sessionStorage.setItem("is_visited", "light-mode-switch"))
            : 1 == c("#dark-mode-switch").prop("checked") && "dark-mode-switch" === e
                ? (c("html").removeAttr("dir"), c("#light-mode-switch").prop("checked", !1), c("#rtl-mode-switch").prop("checked", !1), c("#dark-rtl-mode-switch").prop("checked", !1), c("#bootstrap-style").attr("href", "../../static/css/bootstrap-dark.min.css"), c("#app-style").attr("href", "../../static/css/app-dark.min.css"), sessionStorage.setItem("is_visited", "dark-mode-switch"))
                : 1 == c("#rtl-mode-switch").prop("checked") && "rtl-mode-switch" === e
                    ? (c("#light-mode-switch").prop("checked", !1), c("#dark-mode-switch").prop("checked", !1), c("#dark-rtl-mode-switch").prop("checked", !1), c("#bootstrap-style").attr("href", "../../static/css/bootstrap-rtl.min.css"), c("#app-style").attr("href", "../../static/css/app-rtl.min.css"), c("html").attr("dir", "rtl"), sessionStorage.setItem("is_visited", "rtl-mode-switch"))
                    : 1 == c("#dark-rtl-mode-switch").prop("checked") && "dark-rtl-mode-switch" === e && (c("#light-mode-switch").prop("checked", !1), c("#rtl-mode-switch").prop("checked", !1), c("#dark-mode-switch").prop("checked", !1), c("#bootstrap-style").attr("href", "../../static/css/bootstrap-dark-rtl.min.css"), c("#app-style").attr("href", "../../static/css/app-dark-rtl.min.css"), c("html").attr("dir", "rtl"), sessionStorage.setItem("is_visited", "dark-rtl-mode-switch"))
    }
    function r() {
    ...
    c("#sidebar-menu a").each(function () {
        var e = window
            ...
            .href
            .split(/[?#]/)[0];
        this.href == e && (c(this).addClass("active"), c(this).parent().addClass("mm-active"), c(this)
            .parent()
            .parent()
            .addClass("mm-show"), c(this)
            .parent()
            .parent()
            .prev()
            .addClass("mm-active"), c(this)
            .parent()
            .parent()
            .parent()
            .addClass("mm-active"), c(this)
    ...
    c(".navbar-nav a").each(function () {
        var e = window
            ...
            .href
            .split(/[?#]/)[0];
        this.href == e && (c(this).addClass("active"), c(this).parent().addClass("active"), c(this)
            .parent()
            .parent()
            .addClass("active"), c(this)
            .parent()
            .parent()
            .parent()
            .addClass("active"), c(this)
    ...
    window.sessionStorage && ((e = sessionStorage.getItem("is_visited")) || (e = "light-mode-switch", sessionStorage.setItem("is_visited", e)), c(".right-bar input:checkbox").prop("checked", !1), c("#" + e).prop("checked", !0), l(e)),
    c("#light-mode-switch, #dark-mode-switch, #rtl-mode-switch, #dark-rtl-mode-switch").on("change", function (e) {
        l(e.target.id)
    }),
    ...
    c(".table-check .form-check-input").change(function () {
        c(".table-check .form-check-input:checked").length == c(".table-check .form-check-input").length
